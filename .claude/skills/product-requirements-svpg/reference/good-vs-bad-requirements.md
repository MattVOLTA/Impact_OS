...
#### Good Example (All Four Risks Assessed)
```
Risk Assessment:
...
→ De-risk: Prototype testing with 20 customers, fake door test
...
→ De-risk: High-fi testing Feb 20-24

FEASIBILITY RISK - Medium
- Technical approach validated through spike
- AWS infrastructure sufficient
- Integration with auth system requires upgrade (2 weeks)
